...
<script src="./mobile/js/jquery.simplemodal.1.4.4.min.js"></script>
<script src="./mobile/js/jquery.rating-2.0.js"></script>
<script src="./mobile/js/global.js"></script>
<script src="./mobile/js/jquery.placeholder.min.js"></script>
